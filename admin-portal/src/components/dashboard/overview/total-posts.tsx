...
export interface TotalPostsProps {
  diff?: string | number;
  trend: 'up' | 'down';
  sx?: SxProps;
  postsCount: number;
        ...
        <Stack spacing={2}>
          <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
            <Stack spacing={1}>
              ...
              <Typography variant="h4">{postsCount}</Typography>
            </Stack>
          ...
          {pendingPostsCount ? (
            <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
              <Stack spacing={1}>
                ...
                <Typography variant="h4">{pendingPostsCount}</Typography>
              </Stack>
            </Stack>
          ) : null}
          <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
            <Stack spacing={1}>
              ...
              <Typography variant="h4">{postsCreatedLast30DaysCount}</Typography>
            </Stack>
          </Stack>
          {diff ? (
