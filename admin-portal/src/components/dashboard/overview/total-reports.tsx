...
export interface TotalReportsProps {
  diff?: string | number;
  trend: 'up' | 'down';
  sx?: SxProps;
  reportsCount: number;
          ...
          {pendingReportsCount ? (
            <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
              <Stack spacing={1}>
                ...
                <Typography variant="h4">{pendingReportsCount}</Typography>
              </Stack>
            </Stack>
          ) : null}
          <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
            <Stack spacing={1}>
              <Typography color="text.secondary" variant="overline">
                Reports Created Last 30 Days
              </Typography>
              <Typography variant="h4">{reportsCreatedLast30DaysCount}</Typography>
            </Stack>
          </Stack>
          {diff ? (
